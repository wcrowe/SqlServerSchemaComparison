...
namespace DatabaseCompare
{
    public class DataCompare
    {
        ...
        )
        {
            ...
            var sourceConnectionString = DatabaseCommon.DataAccess.GetConnectionString("localhost,1401","Northwind", "Mustang74","sa");
            var sourceData = DatabaseCommon.DataAccess.GetDataTable(sourceConnectionString, sql);
            var targetConnectionString = DatabaseCommon.DataAccess.GetConnectionString("localhost,1401", "work", "Mustang74", "sa");
